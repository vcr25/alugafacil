                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <textarea class="form-control" name="produto_video_link" rows="2" style="min-height: 100px"><?php echo (isset($produto) ? $produto->produto_video_link : set_value('produto_video_link')); ?></textarea>

                                    <?php echo form_error('produto_video_link', '<div class="text-danger">', '</div>'); ?>
