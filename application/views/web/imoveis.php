        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              ...
              <span class="color-text-a"> <?php echo $subtitulo; ?></span>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="card-box-a card-shadow">
              ...
              <div class="img-box-a">
                <img src="<?php echo base_url('uploads/produtos/'.$prod_destaques->foto_caminho)?>"  alt="<?php echo word_limiter($prod_destaques->produto_nome, 2); ?>" class="img-a img-fluid">
              </div>
