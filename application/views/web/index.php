        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card-box-c foo">
              ...
              <div class="card-body-c">
                <p class="content-c">
                  Encontre casas para alugar definitivo ou para temporadas e finais de semanas.
                  Tudo em um só lugar...
                </p>
              </div>
              <div class="card-footer-c">
          ...
          <div class="col-md-6">
            <div class="card-box-c foo">
              ...
              <div class="card-body-c">
                <p class="content-c">
                 Aqui você encontrará os melhores imóveis da cidade de Ubatuba com os melhores preços.
                </p>
              </div>
              <div class="card-footer-c">
                <a href="<?php echo base_url('contato'); ?>" class="link-c link-icon">Leia mais
