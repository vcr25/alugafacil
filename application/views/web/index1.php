                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="<?php echo base_url('produto/'.$prod_destaques->produto_meta_link); ?>">
                                                    <img src="<?php echo base_url('uploads/produtos/'.$prod_destaques->foto_caminho)?>" alt="<?php echo $prod_destaques->produto_meta_link; ?>">
                                                </a>
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="<?php echo base_url('produto/'.$prod_destaques->produto_meta_link); ?>"><?php echo word_limiter($prod_destaques->produto_nome, 5); ?></a></h4>
                                                    <div class="price-box">
                                                        <span class="new-price">R$: <?php echo number_format($prod_destaques->produto_valor, 2); ?></span>
                                                    </div>
                                                </div>
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                                        <li class="add-cart active"><a href="<?php echo base_url('produto/'.$prod_destaques->produto_meta_link); ?>">Visualizar</a></li>
