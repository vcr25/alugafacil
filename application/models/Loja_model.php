...
class Loja_model extends CI_Model{
    ...
    public function get_produto_destaque($num_produto_destaque = NULL)
    {
        $this->db->select([
            'produtos.produto_id',
        ...
        $this->db->limit($num_produto_destaque);
    ...
    public function get_produto_banner($num_produto_destaque = NULL)
    {
      $this->db->select([
          'produtos.produto_id',
          'produtos.produto_codigo',
